classdef nonkeyFrameSampling < dagnn.Filter
  properties
    size = [0 0 0 0]
    hasBias = true
    opts = {'cuDNN'}
  ...
  methods
    function outputs = forward(obj, inputs, params)
      ...
      outputs{1} = vl_nnconv(...
        inputs{1}(:,:,obj.idx,:), params{1}, params{2}, ...
        'pad', obj.pad, ...
        'stride', obj.stride, ...
        'dilate', obj.dilate, ...
        obj.opts{:}) ;
    ...
    function [derInputs, derParams] = backward(obj, inputs, params, derOutputs)
      ...
      [derInputs{1}, derParams{1}, derParams{2}] = vl_nnconv(...
        inputs{1}(:,:,obj.idx,:), params{1}, params{2}, derOutputs{1}, ...
        'pad', obj.pad, ...
        'stride', obj.stride, ...
        'dilate', obj.dilate, ...
        obj.opts{:}) ;
    ...
    function obj = nonkeyFrameSampling(varargin)
      obj.load(varargin) ;
